...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${fontSans.variable} ${fontSerif.variable} ${fontMono.variable} selection:bg-primary/80 selection:text-primary-foreground antialiased min-h-screen bg-background relative`}
      >
